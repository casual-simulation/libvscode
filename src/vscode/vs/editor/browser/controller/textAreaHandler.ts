    ...
    constructor(
                ...
                if (
                    ...
                    if (platform.isMacintosh) {
                        ...
                        if (selection.isEmpty()) {
                            ...
                            let textBefore = this._getWordBeforePosition(
                                position
                            );
                            if (textBefore.length === 0) {
                                textBefore = this._getCharacterBeforePosition(
                                    position
                                );
                            }
        ...
        this._register(
            this._textAreaInput.onCompositionStart((e) => {
                ...
                const column =
                    this._selections[0].startColumn -
                    (e.moveOneCharacterLeft ? 1 : 0);
