...
export class WorkbenchKeybindingService extends AbstractKeybindingService {
	...
	constructor(
		...
		// libvscode change - Use the DOM element that the workbench was added to instead of
		const listenerRoot = ((<any>window).VSCODE_DOM_ELEMENT ?? window);

		this._register(dom.addDisposableListener(listenerRoot, dom.EventType.KEY_DOWN, (e: KeyboardEvent) => {
