...
(function () {
    ...
    function createWebviewManager(host) {
        ...
        const handleInnerClick = (event) => {
            ...
            let baseElement = event.view.document.getElementsByTagName(
                'base'
            )[0];
            /** @type {any} */
                        ...
                        if (!isNaN(initData.initialScrollProgress)) {
                            if (window.scrollY === 0) {
                                window.scroll(
                                    0,
                                    body.clientHeight *
                                        initData.initialScrollProgress
                                );
                            }
                        }
                    };
